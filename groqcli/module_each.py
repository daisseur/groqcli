...
@click.option("--system", type=click.Choice(list(cli.PREDEFINED_SYSTEM_PROMPTS.keys())), help="Predefined system prompt")
...
def cli_files(directory: click.Path, model, temperature, max_tokens, top_p, system, custom_system, each_output, output_file, send_path, prompt):
